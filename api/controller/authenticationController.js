...
const createAccount = async (req, res) => {
    ...
    try {
        const { account_name, account_email, password, account_type} = req.body;

        const sql = "INSERT INTO account (account_name, email_address, passwd, account_type) VALUES (?, ?, ?, ?)";
        const hashedpassword = await bcrypt.hash(password, saltRounds)
        const values = [account_name, account_email, hashedpassword, account_type];
